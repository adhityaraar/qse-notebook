...
//    public static String AES = "AES";
    ...
    public static String decrypt(String encryptedMessage, SecretKeySpec aesKey) throws Exception {
        ...
        System.out.println("im decrypting : " + new String(Base64.getEncoder().encode(aesKey.getEncoded()), StandardCharsets.UTF_8));
    ...
    public static String encrypt(String message, SecretKeySpec aesKey) throws Exception {
        ...
        System.out.println("im encrypting : " + new String(Base64.getEncoder().encode(aesKey.getEncoded()), StandardCharsets.UTF_8));
    ...
    public static SecretKeySpec generateAESKey(byte[] secretKey){
        return new SecretKeySpec(secretKey, 0, 16, Algorithm.AES.getName());
    }
